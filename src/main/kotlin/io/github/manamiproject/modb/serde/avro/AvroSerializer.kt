...
public interface AvroSerializer {
    ...
    /**
     * Serializes an anime list to the [manami-project/anime-offline-database](https://github.com/manami-project/anime-offline-database) file.
     * @since 5.0.0
    ...
    /**
     * Serializes a list of dead entries to one of the [manami-project/anime-offline-database](https://github.com/manami-project/anime-offline-database) dead entries files.
     * @since 5.0.0
